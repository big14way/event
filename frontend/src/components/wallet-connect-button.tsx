              ...
              if (!connected) {
                return (
                  <button
                    ...
                    type="button"
                    className={`px-6 py-3 bg-gradient-to-r from-[#dd7e9a] to-[#dd7e9a] text-white rounded-lg font-semibold hover:opacity-90 transition-all duration-200 border border-[#dd7e9a]/30 flex items-center justify-center ${className || ''}`}
                  >
                    Connect Wallet
                  </button>
                )
              ...
              return (
                <div className="flex items-center gap-3">
                  <button
                    onClick={openChainModal}
                    type="button"
                    className="flex items-center gap-2 px-4 py-2 bg-[var(--color-dark-navy)]/80 border border-[#dd7e9a]/30 text-white rounded-lg hover:bg-[var(--color-dark-navy)] hover:opacity-90 transition-all duration-200"
                  >
                    {chain.hasIcon && (
                      <div
                        style={{
